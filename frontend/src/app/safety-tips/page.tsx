    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2">Protect Your Personal Information</h2>
            <p className="text-gray-600 text-sm">
              Never share sensitive personal details like your home address, financial information, or
              workplace details until you’ve established trust.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2">Meet in Public Places</h2>
            <p className="text-gray-600 text-sm">
              For your first few meetings, always choose public locations with plenty of people around. Inform a
        ...
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2">Take Time to Know Each Other</h2>
            <p className="text-gray-600 text-sm">
              Build trust gradually through conversations on our platform before moving to external
        ...
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2">Use Your Own Transportation</h2>
            <p className="text-gray-600 text-sm">
              Arrange your own transportation to and from your meeting location. This ensures you can
        ...
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm">
              If something feels wrong or uncomfortable about a person or situation, don’t ignore that
              feeling. Your safety comes first.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start bg-white p-6 rounded-lg shadow-sm border transform transition duration-300 hover:-translate-y-2 hover:shadow-lg">
          ...
          <div>
            <h2 className="font-semibold text-lg mb-2">Report Suspicious Behavior</h2>
            <p className="text-gray-600 text-sm">
              If someone is behaving inappropriately or suspiciously, use our reporting feature to alert
      ...
      <div className="max-w-4xl mx-auto px-4 pb-16">
        <div className="bg-red-50 border border-red-300 rounded-lg p-6 flex items-start transform transition duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div>
            <h2 className="text-lg font-semibold text-red-600 mb-2">Emergency Situations</h2>
            <p className="text-gray-700 text-sm mb-2">
              If you ever feel in danger or uncomfortable during a meeting, don’t hesitate to:
            </p>
            <ul className="list-disc list-inside text-gray-600 text-sm space-y-1">
              ...
              <li>Report the incident to DevShaadi through our 24/7 safety hotline.</li>
            </ul>
          </div>
        </div>
      </div>
